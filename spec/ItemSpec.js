...
(function() {
  describe("Item", function() {
    ...
    return describe("Updating an item", function() {
      it("updates properties passed in", function() {
        item.update({
          title: "Super Mouse",
          price: 15
        });
      ...
      return describe("getting ratings from a 3rd party API", function() {
        beforeEach(function() {
          return spyOn(item, 'getRatings').andCallFake(function() {
            return JSON.parse('{"ratings":[{"rating": 4, "review":"This is a really great product", "source": "Amazon"},{"rating": 1, "review":"It was just okay", "source": "PC world"},{"rating": 3, "review":"Its pretty average", "source": "Ebay"}]}');
          });
        });
